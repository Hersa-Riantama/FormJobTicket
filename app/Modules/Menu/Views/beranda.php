...
<head>
  ...
  <style type="text/css">
    ...
    .layout-menu-fixed-offcanvas .layout-navbar-full .layout-menu {
      top: 78.88333129882812px !important;
    }

    .layout-page {
      padding-top: 78.88333129882812px !important;
    }
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Montserrat%3Aital%2Cwght%400%2C400&family=Poppins%3Aital%2Cwght%400%2C400%3B0%2C500%3B0%2C700&display=swap">
</head>
...
<body>
    ...
    <div class="container">
      <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
        ...
        <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8">
          ...
          <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/landing-page.html" class="app-brand-link">
        ...
        <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto">
            <li class="nav-item">
              <a class="nav-link fw-medium active" aria-current="page" href="http://localhost:800/beranda">Beranda</a>
            </li>
          </ul>
        </div>
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          <!-- navbar button: Start -->
          <li>
            <a href="http://localhost:8080/api/login" class="btn btn-primary" target="_blank"><span class="tf-icons bx bx-log-in-circle scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Login/Daftar</span></a>
          </li>
          <!-- navbar button: End -->
        </ul>
        <!-- Toolbar: End -->
  ...
  <div data-bs-spy="scroll" class="scrollspy-example">
    ...
    <section id="hero-animation">
      <div id="landingHero" class="section-py landing-hero position-relative">
        <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/hero-bg.png" alt="hero background" class="position-absolute top-0 start-50 translate-middle-x object-fit-cover w-100 h-100" data-speed="1">
        <div class="container">
          <div class="hero-text-box text-center position-relative">
            ...
            <div class="landing-hero-btn d-inline-block position-relative">
              <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium">Join community
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/Join-community-arrow.png" alt="Join community arrow" class="scaleX-n1-rtl"></span>
          ...
          <div id="heroDashboardAnimation" class="hero-animation-img">
            <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
              <div id="heroAnimationImg" class="position-relative hero-dashboard-img" style="transform: perspective(1200px) rotateX(-0.03deg) rotateY(-0.82deg) scale3d(1, 1, 1);">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/hero-dashboard-light.png" alt="hero dashboard" class="animation-img" data-app-light-img="front-pages/landing-page/hero-dashboard-light.png" data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/hero-elements-light.png" alt="hero elements" class="position-absolute hero-elements-img animation-img top-0 start-0" data-app-light-img="front-pages/landing-page/hero-elements-light.png" data-app-dark-img="front-pages/landing-page/hero-elements-dark.png" style="transform: translateZ(1rem);">
              </div>
            </a>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <h4 class="text-center mb-1">
          <span class="position-relative fw-extrabold z-1">Everything you need
            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1">
          </span>
        ...
        <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="text-center mb-4">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/laptop.svg" alt="laptop charging">
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="text-center mb-4">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/rocket.svg" alt="transition up">
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="text-center mb-4">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/paper.svg" alt="edit">
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="text-center mb-4">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/check.svg" alt="3d select solid">
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="text-center mb-4">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/user.svg" alt="user">
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="text-center mb-4">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/keyboard.svg" alt="keyboard">
            </div>
          ...
          <div class="col-md-6 col-lg-7 col-xl-9">
            <div class="swiper-reviews-carousel overflow-hidden">
              <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" id="swiper-reviews">
                <div class="swiper-wrapper" style="cursor: grab; transition-duration: 0ms; transform: translate3d(-708px, 0px, 0px); transition-delay: 0ms;" id="swiper-wrapper-e757fec75b62c812" aria-live="off">

                  <div class="swiper-slide" style="width: 328px; margin-right: 26px;" role="group" aria-label="2 / 6" data-swiper-slide-index="1">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo-2.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        <p>
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar me-3 avatar-sm">
                            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/2.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                  ...
                  <div class="swiper-slide swiper-slide-prev" style="width: 328px; margin-right: 26px;" role="group" aria-label="3 / 6" data-swiper-slide-index="2">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo-3.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        <p>
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar me-3 avatar-sm">
                            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/3.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                  ...
                  <div class="swiper-slide swiper-slide-active" style="width: 328px; margin-right: 26px;" role="group" aria-label="4 / 6" data-swiper-slide-index="3">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo-4.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        <p>
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar me-3 avatar-sm">
                            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/4.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                  ...
                  <div class="swiper-slide swiper-slide-next" style="width: 328px; margin-right: 26px;" role="group" aria-label="5 / 6" data-swiper-slide-index="4">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo-5.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        <p>
                          “I've never used a theme as versatile and flexible as Vuexy. It's my go to for building
                          dashboard sites on almost any project.”
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar me-3 avatar-sm">
                            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/5.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                            <h6 class="mb-0">Eugenia Moore</h6>
                            <p class="small text-muted mb-0">Founder of Hubspot</p>
                  ...
                  <div class="swiper-slide" style="width: 328px; margin-right: 26px;" role="group" aria-label="6 / 6" data-swiper-slide-index="5">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo-6.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        <p>
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar me-3 avatar-sm">
                            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/1.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                            <h6 class="mb-0">Sara Smith</h6>
                            <p class="small text-muted mb-0">Founder of Continental</p>
                  ...
                  <div class="swiper-slide" style="width: 328px; margin-right: 26px;" role="group" aria-label="1 / 6" data-swiper-slide-index="0">
                    <div class="card h-100">
                      <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                        <div class="mb-4">
                          <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo-1.png" alt="client logo" class="client-logo img-fluid">
                        </div>
                        <p>
                ...
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-e757fec75b62c812"></div>
                <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-e757fec75b62c812"></div>
        ...
        <div class="swiper-logo-carousel pt-8">
          <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" id="swiper-clients-logos">
            <div class="swiper-wrapper" id="swiper-wrapper-c3319e4db27de5b9" aria-live="off">
              <div class="swiper-slide swiper-slide-active" style="width: 144px;" role="group" aria-label="1 / 5">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo_1-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_1-light.png" data-app-dark-img="front-pages/branding/logo_1-dark.png">
              </div>
              <div class="swiper-slide swiper-slide-next" style="width: 144px;" role="group" aria-label="2 / 5">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo_2-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_2-light.png" data-app-dark-img="front-pages/branding/logo_2-dark.png">
              </div>
              <div class="swiper-slide" style="width: 144px;" role="group" aria-label="3 / 5">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo_3-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_3-light.png" data-app-dark-img="front-pages/branding/logo_3-dark.png">
              </div>
              <div class="swiper-slide" style="width: 144px;" role="group" aria-label="4 / 5">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo_4-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_4-light.png" data-app-dark-img="front-pages/branding/logo_4-dark.png">
              </div>
              <div class="swiper-slide" style="width: 144px;" role="group" aria-label="5 / 5">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/logo_5-light.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_5-light.png" data-app-dark-img="front-pages/branding/logo_5-dark.png">
              </div>
            </div>
            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
          </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card mt-3 mt-lg-0 shadow-none">
              <div class="bg-label-primary border border-bottom-0 border-label-primary position-relative team-image-box">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/team-member-1.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card mt-3 mt-lg-0 shadow-none">
              <div class="bg-label-info border border-bottom-0 border-label-info position-relative team-image-box">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/team-member-2.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card mt-3 mt-lg-0 shadow-none">
              <div class="bg-label-danger border border-bottom-0 border-label-danger position-relative team-image-box">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/team-member-3.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card mt-3 mt-lg-0 shadow-none">
              <div class="bg-label-success border border-bottom-0 border-label-success position-relative team-image-box">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/team-member-4.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image">
              </div>
        ...
        <div class="text-center mb-12">
          <div class="position-relative d-inline-block pt-3 pt-md-0">
            <label class="switch switch-sm switch-primary me-0">
              ...
              <input type="checkbox" class="switch-input price-duration-toggler" checked="checked">
            ...
            <div class="pricing-plans-item position-absolute d-flex">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/pricing-plans-arrow.png" alt="pricing plans arrow" class="scaleX-n1-rtl">
        ...
        <div class="row g-6 pt-lg-5">
            ...
            <div class="card">
              <div class="card-header">
                <div class="text-center">
                  <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/paper-airplane.png" alt="paper airplane icon" class="mb-8 pb-2">
              ...
              <div class="card-body">
                ...
                <div class="d-grid mt-8">
                  <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/payment-page.html" class="btn btn-label-primary">Get Started</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-6">
            <div class="card border border-primary shadow-xl">
              <div class="card-header">
                <div class="text-center">
                  <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/plane.png" alt="plane icon" class="mb-8 pb-2">
          ...
          <div class="col-xl-4 col-lg-6">
            <div class="card">
              <div class="card-header">
                <div class="text-center">
                  <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/shuttle-rocket.png" alt="shuttle rocket icon" class="mb-8 pb-2">
        ...
        <div class="row gy-6">
          <div class="col-sm-6 col-lg-3">
            <div class="card border border-primary shadow-none">
              <div class="card-body text-center">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/laptop.svg" alt="laptop" class="mb-4">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card border border-success shadow-none">
              <div class="card-body text-center">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/user-success.svg" alt="laptop" class="mb-4">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card border border-info shadow-none">
              <div class="card-body text-center">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/diamond-info.svg" alt="laptop" class="mb-4">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card border border-warning shadow-none">
              <div class="card-body text-center">
                <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/check-warning.svg" alt="laptop" class="mb-4">
    ...
    <section id="landingFAQ" class="section-py bg-body landing-faq">
      <div class="container">
        ...
        <div class="row gy-12 align-items-center">
          <div class="col-lg-5">
            <div class="text-center">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/faq-boy-with-logos.png" alt="faq boy with logos" class="faq-image">
            </div>
          </div>
          <div class="col-lg-7">
    ...
    <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
      <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/cta-bg-light.png" class="position-absolute bottom-0 end-0 scaleX-n1-rtl h-100 w-100 z-n1" alt="cta image" data-app-light-img="front-pages/backgrounds/cta-bg-light.png" data-app-dark-img="front-pages/backgrounds/cta-bg-dark.png">
      <div class="container">
        <div class="row align-items-center gy-12">
          <div class="col-lg-6 text-start text-sm-center text-lg-start">
            ...
            <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/payment-page.html" class="btn btn-lg btn-primary">Get Started</a>
          </div>
          <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/cta-dashboard.png" alt="cta dashboard" class="img-fluid mt-lg-4">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row g-6">
          <div class="col-lg-5">
            <div class="contact-img-box position-relative border p-2 h-100">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/contact-border.png" alt="contact border" class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl">
              <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/contact-customer-service.png" alt="contact customer service" class="contact-img w-100 scaleX-n1-rtl">
              <div class="p-4 pb-2">
                <div class="row g-4">
  ...
  <!-- <footer class="landing-footer bg-body footer-text">
    <div class="footer-top position-relative overflow-hidden z-1">
      <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/footer-bg.png" alt="footer bg" class="footer-bg banner-bg-img z-n1">
      <div class="container">
        <div class="row gx-0 gy-6 g-lg-10">
          <div class="col-lg-5">
            <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/landing-page.html" class="app-brand-link mb-6">
              <span class="app-brand-logo demo">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            ...
            <ul class="list-unstyled">
              <li class="mb-4">
                <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/pricing-page.html" class="footer-link">Pricing</a>
              </li>
              <li class="mb-4">
                <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/payment-page.html" class="footer-link">Payment<span class="badge bg-primary ms-2">New</span></a>
              </li>
              <li class="mb-4">
                <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/checkout-page.html" class="footer-link">Checkout</a>
              </li>
              <li class="mb-4">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <a href="javascript:void(0);" class="d-block mb-4"><img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/apple-icon.png" alt="apple icon"></a>
            <a href="javascript:void(0);" class="d-block"><img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/google-play-icon.png" alt="google play icon"></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
        ...
        <div>
          <a href="https://github.com/themeselection" class="me-4" target="_blank">
            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/github.svg" alt="github icon">
          </a>
          <a href="https://www.facebook.com/ThemeSelections/" class="me-4" target="_blank">
            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/facebook.svg" alt="facebook icon">
          </a>
          <a href="https://twitter.com/Theme_Selection" class="me-4" target="_blank">
            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/twitter.svg" alt="twitter icon">
          </a>
          <a href="https://www.instagram.com/themeselection/" target="_blank">
            <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/instagram.svg" alt="google icon">
          </a>
        </div>
      </div>
    </div>
              ...
              <div class="form-check custom-option custom-option-icon checked">
                <label class="form-check-label custom-option-content p-0" for="customRadioIconlight">
                  <span class="custom-option-body mb-0">
                    <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/light.svg" alt="Light" class="img-fluid scaleX-n1-rtl">
                  </span>
            ...
            <div class="col-4 px-2">
              <div class="form-check custom-option custom-option-icon">
                <label class="form-check-label custom-option-content p-0" for="customRadioIcondark">
                  <span class="custom-option-body mb-0">
                    <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/dark.svg" alt="Dark" class="img-fluid scaleX-n1-rtl">
                  </span>
            ...
            <div class="col-4 px-2">
              <div class="form-check custom-option custom-option-icon">
                <label class="form-check-label custom-option-content p-0" for="customRadioIconsystem">
                  <span class="custom-option-body mb-0">
                    <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/system.svg" alt="System" class="img-fluid scaleX-n1-rtl">
                  </span>
            ...
            <div class="col-4 px-2">
              <div class="form-check custom-option custom-option-icon checked">
                <label class="form-check-label custom-option-content p-0" for="directionRadioIconltr">
                  <span class="custom-option-body mb-0">
                    <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/ltr.svg" alt="Left to Right (En)" class="img-fluid scaleX-n1-rtl">
                  </span>
              ...
              <label class="form-check-label small text-nowrap text-body mt-1" for="directionRadioIconltr">Left to Right (En)</label>
            </div>
            <div class="col-4 px-2">
              <div class="form-check custom-option custom-option-icon">
                <label class="form-check-label custom-option-content p-0" for="directionRadioIconrtl">
                  <span class="custom-option-body mb-0">
                    <img src="Demo%20_%20Landing%20Page%20-%20Front%20Pages%20_%20sneat%20-%20Bootstrap%20Dashboard%20PRO_files/rtl.svg" alt="Right to Left (Ar)" class="img-fluid scaleX-n1-rtl">
                  </span>
                  <input name="directionRadioIcon" class="form-check-input d-none" type="radio" value="rtl" id="directionRadioIconrtl">
                </label>
              </div>
              <label class="form-check-label small text-nowrap text-body mt-1" for="directionRadioIconrtl">Right to Left (Ar)</label>
            </div>
          </div>
        </div>
      </div>
