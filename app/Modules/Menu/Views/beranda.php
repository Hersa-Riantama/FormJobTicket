...
<head>
  ...
  <script type="text/javascript" src="../../assets/js/api.min.js" async="" data-user="252882" data-account="269977"></script>
      ...
      <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
        ...
        <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
              <a class="nav-link fw-medium" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/landing-page.html#landingTeam">Team</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/landing-page.html#landingFAQ">FAQ</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/landing-page.html#landingContact">Contact us</a>
            </li>
                ...
                <div class="row gy-4">
                  <div class="col-12 col-lg">
                    ...
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        <a class="nav-link mega-dropdown-link" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/pricing-page.html">
                          <i class="bx bx-radio-circle me-1"></i>
                          <span data-i18n="Pricing">Pricing</span>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link mega-dropdown-link" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/payment-page.html">
                          <i class="bx bx-radio-circle me-1"></i>
                          <span data-i18n="Payment">Payment</span>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link mega-dropdown-link" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/checkout-page.html">
                          <i class="bx bx-radio-circle me-1"></i>
                          <span data-i18n="Checkout">Checkout</span>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link mega-dropdown-link" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/help-center-landing.html">
                          <i class="bx bx-radio-circle me-1"></i>
      ...
      <div class="container">
        <div class="row align-items-center gy-12">
          ...
          <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
            <img src="../../assets/img/front-pages/backgrounds/cta-dashboard.png" alt="cta dashboard" class="img-fluid mt-lg-4">
          </div>
        </div>
      </div>
    </section>
