                                                    ...
                                                    <div class="col-xl mb-2 px-0">
                                                        <div class="card h-100 <?= $tiketData['approved_order_koord'] === 'Y' ? 'mb-2' : 'mb-5'; ?>" style="border: 1px solid pink;">
                                                            ...
                                                            if ($level_user === 'Koord Editor' && $tiketData['approved_order_koord'] !== 'Y'): ?>
                                                                <button class="btn btn-success w-100 mt-2" id="approveButton" onclick="approveTicket(<?= $tiketData['id_tiket'] ?>,'Koord Editor')">Approve</button>
                                        ...
                                        <div class="row mb-0">
                                            ...
                                            <div class="col-xl-3 mb-3">
                                                ...
                                                <div class="row mt-4 mx-0">
                                                    ...
                                                    <div class="col-xl mb-2 px-0">
                                                        <div class="card h-100 <?= $tiketData['approved_multimedia'] === 'Y' ? 'mb-2' : 'mb-5'; ?>" style="border: 1px solid pink;">
                                                            <div class="card-body p-2 d-flex justify-content-left" id="CurentDate" style="height: 25px;">
                                                                <p class="text-start text-primary" style="font-size:xx-small;">tanggal: </p>
                                                                <p class="text-end" style="font-size:xx-small;">dd/mm/yyyy</p>
                                                            </div>
                                                            ...
                                                            if ($level_user === 'Tim Multimedia' && $tiketData['approved_multimedia'] !== 'Y'): ?>
                                                                <button class="btn btn-success w-100 mt-2" id="approveButton" onclick="approveTicket(<?= $tiketData['id_tiket'] ?>,'Tim Multimedia')">Approve</button>
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="row mb-0">
                                            ...
                                            <div class="col-xl-7 mb-3">
                                                ...
                                                <div class="row mt-4 mx-0">
                                                    <div class="col-xl mb-2 px-0">
                                                        <div class="card h-100 <?= $tiketData['approved_acc_koord'] === 'Y' ? 'mb-2' : 'mb-5'; ?>" style="border: 1px solid pink;">
                                                            <div class="card-body p-2 d-flex justify-content-left" id="CurentDate" style="height: 25px;">
                                                                <p class="text-start text-primary" style="font-size:xx-small;">tanggal: </p>
                                                                <p class="text-end" style="font-size:xx-small;">dd/mm/yyyy</p>
                                                            </div>
                                                            ...
                                                            if ($level_user === 'Koord Editor' && $tiketData['approved_acc_koord'] !== 'Y'): ?>
                                                                <button class="btn btn-success w-100 mt-2" id="approveButton" onclick="approveTicket(<?= $tiketData['id_tiket'] ?>,'Acc Koord Editor')">Approve</button>
                                                    ...
                                                    <div class="col-xl mb-2 px-0">
                                                        <div class="card h-100 <?= $tiketData['approved_acc_manager'] === 'Y' ? 'mb-2' : 'mb-5'; ?>" style="border: 1px solid pink;">
                                                            <div class="card-body p-2 d-flex justify-content-left" id="CurentDate" style="height: 25px;">
                                                                <p class="text-start text-primary" style="font-size:xx-small;">tanggal: </p>
                                                                <p class="text-end" style="font-size:xx-small;">dd/mm/yyyy</p>
                                                            </div>
                                                            ...
                                                            if ($level_user === 'Manager Platform' && $tiketData['approved_acc_manager'] !== 'Y'): ?>
                                                                <button class="btn btn-success w-100 mt-2" id="approveButton" onclick="approveTicket(<?= $tiketData['id_tiket'] ?>,'Manager Platform')">Approve</button>
                                            ...
                                            <div class="col-xl-4" style="margin-left: auto;">
                                                ...
                                                <div class="row mt-4 mx-0">
                                                    <div class="col-xl mb-2 px-0">
                                                        <div class="card h-100 <?= $tiketData['approved_order_admin'] === 'Y' ? 'mb-2' : 'mb-5'; ?>" style="border: 1px solid pink;">
                                                            <div class="card-body p-2 d-flex justify-content-left" id="CurentDate" style="height: 25px;">
                                                                <p class="text-start text-primary" style="font-size:xx-small;">tanggal: </p>
                                                                <p class="text-end" style="font-size:xx-small;">dd/mm/yyyy</p>
                                                            </div>
                                                            ...
                                                            if ($level_user === 'Admin Sistem' && $tiketData['approved_order_admin'] !== 'Y'): ?>
                                                                <button class="btn btn-success w-100 mt-2" id="approveButton" onclick="approveTicket(<?= $tiketData['id_tiket'] ?>,'Admin Sistem')">Approve</button>
